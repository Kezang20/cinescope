...
async function renderHome() {
    ...
    const hero = el('div', { class: 'hero' },
        el('img', { src: 'welcome-poster.png', alt: 'Welcome Poster' }),
...
function renderAbout() {
    ...
    const friendsSection = el('div', {
        ...
        el('div', { style: 'text-align:center;' },
            el('img', { src: 'images/friend1.jpg', alt: 'Jigme Wangchuk', style: 'width:120px; height:120px; border-radius:50%; object-fit:cover;' }),
            el('p', { style: 'margin-top:6px; color:#e7eef6; font-size:0.9rem;' }, 'Jigme Wangchuk')
        ),
        el('div', { style: 'text-align:center;' },
            el('img', { src: 'images/friend2.jpg', alt: 'Duptho Wangmo', style: 'width:120px; height:120px; border-radius:50%; object-fit:cover;' }),
            el('p', { style: 'margin-top:6px; color:#e7eef6; font-size:0.9rem;' }, 'Duptho Wangmo')
        ),
        el('div', { style: 'text-align:center;' },
            el('img', { src: 'images/friend3.jpg', alt: 'Jamyang Choden', style: 'width:120px; height:120px; border-radius:50%; object-fit:cover;' }),
            el('p', { style: 'margin-top:6px; color:#e7eef6; font-size:0.9rem;' }, 'Jamyang Choden')
        ),
        el('div', { style: 'text-align:center;' },
            el('img', { src: 'images/friend4.jpg', alt: 'Kalpana Monger', style: 'width:120px; height:120px; border-radius:50%; object-fit:cover;' }),
            el('p', { style: 'margin-top:6px; color:#e7eef6; font-size:0.9rem;' }, 'Kalpana Monger')
        ),
        el('div', { style: 'text-align:center;' },
            el('img', { src: 'images/friend5.jpg', alt: 'Kezang Dema', style: 'width:120px; height:120px; border-radius:50%; object-fit:cover;' }),
            el('p', { style: 'margin-top:6px; color:#e7eef6; font-size:0.9rem;' }, 'Kezang Dema')
        ),
        el('div', { style: 'text-align:center;' },
            el('img', { src: 'images/friend6.jpg', alt: 'Karma Wangchuk', style: 'width:120px; height:120px; border-radius:50%; object-fit:cover;' }),
            el('p', { style: 'margin-top:6px; color:#e7eef6; font-size:0.9rem;' }, 'Karma Wangchuk')
        )
    );

    aboutCard.appendChild(friendsSection);
